...
export const COMMANDS: Command[] = [
  ...
  { id: 'panel:chat-analyst', keywords: ['wm analyst', 'analyst', 'ai analyst', 'chat analyst', 'ask ai', 'intelligence analyst'], label: 'Panel: Cortex Analyst', icon: '\u{1F916}', category: 'panels' },
