...
const CACHE_TTL = 108000; // 30h: sobrevive el cron diario de seed-all en este fork (Adrian 2026-09-24) // 90min — 1h buffer over 10min cron cadence (was 60min = 50min buffer)
